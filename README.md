...
**Debug:** In order to see how the code executes and whether your specific macro was triggered, click the AHK icon in the system tray (shown below) and select *Open* to see what lines were ran. ![ahk](ahk.png)